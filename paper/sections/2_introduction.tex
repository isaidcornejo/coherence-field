...
\cite{Fisher1922,Rao1945,AmariNagaoka2000,Amari2016}. Its geometric interpretation
underlies classical asymptotic theory, natural gradient optimization
\cite{Amari1998,Martens2014}, exponential-family structure
...
In empirical applications, we further clarify the operational interpretation of
this diagnostic by accounting explicitly for finite-sample resolution effects,
distinguishing formal geometric alignment from resolvable coherent alignment,
without modifying the underlying invariant construction.
