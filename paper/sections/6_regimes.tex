...
\input{figures/manual/alignment_regimes.tex}
...
\begin{tabular}{ccl}
\toprule
Regime & Scalar Signature & Interpretation \\
\midrule
Equilibrium & $\mathcal{A}=0$ & empirical curvature matches Fisher expectation \\
Suppression & $\mathcal{A}<0$ & empirical sensitivity contracted relative to Fisher \\
Excess Alignment & $\mathcal{A}>0$ & empirical reinforcement; anisotropy increased \\
\bottomrule
\end{tabular}
\end{center}
