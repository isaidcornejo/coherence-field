...
Figures are saved to: `paper/src/figures/`
...
* `alignment_core.py` — computation of H, A_q, φ
* `experiment_io.py` — saving results and figures

Score functions and models remain experiment-specific to preserve scientific clarity.
